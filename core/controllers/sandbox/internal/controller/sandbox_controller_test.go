...
func makeReconciler(t *testing.T, objs ...client.Object) (*Reconciler, *giteaServer) {
	...
	r := &Reconciler{
		...
		MarketplaceAPIURL:           "http://marketplace-api.catalyst-system.svc.cluster.local:80",
		StorageS3Endpoint:           "http://seaweedfs-s3.seaweedfs.svc.cluster.local:8333",
		...
		KeycloakAdminURL:            "http://keycloak.keycloak.svc.cluster.local:80",
