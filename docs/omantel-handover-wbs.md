...
flowchart TB
    ...
    class T316,T327,T331,T338,T370,T371,T373,T374,T375,T376,T377,T378,T379,T380,T381,T382,T383,T384,T387,T392,T425,T428,T429,T430 done
    class T385,T438 wip
...
| #385 | 🟡 in flight — bp-catalyst-platform single-blueprint verification (Phase 6 of #369). Worktree `.worktrees/omantel-385`, branch `fix/385-omantel`. | (PR pending) | gates Phase 7 (#317/#319 handover machinery) |
| #438 | 🟡 in flight — vendor-coupling guardrail path mode-gate fix (`scripts/check-vendor-coupling.sh` checks wrong path; #383 flagged). Worktree `.worktrees/omantel-438`, branch `fix/438-omantel`. | (PR pending) | unblocks hard-fail mode auto-engage on this repo |
