...
| #374 | 🟡 re-dispatching — first agent watchdog-killed (no commits pushed); STAY-TIGHT brief on next dispatch (worktree `.worktrees/omantel-374`, branch `fix/374-omantel`) | (PR pending) | |
