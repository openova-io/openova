...
flowchart TB
    ...
    class T316,T317,T327,T331,T338,T370,T371,T373,T374,T375,T376,T377,T378,T379,T380,T381,T382,T383,T384,T385,T387,T392,T425,T428,T429,T430,T438 done
    class T319,T322,T323,T326 wip
...
| #322 | 🟡 in flight (epic #320 IAM) — UserAccess CRD `useraccesses.access.openova.io/v1alpha1` + Crossplane XRD/Composition (Keycloak GroupMembership + K8s RoleBinding) + canonical `openova:application-{admin,editor,viewer}` ClusterRoles. Worktree `.worktrees/omantel-322`, branch `fix/322-omantel`. | (PR pending) | unblocks #323 |
