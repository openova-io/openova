...
| 7 | [catalog-edit-single-source-iac](uat-walkthrough/catalog-edit-single-source-iac-not-overlay.md) | #3668 | /catalog/<bp> inline edit · Edit-IaC · icon picker | ✅**~18** / ❌**1** — single-source IaC editor WORKS (Edit-IaC writes the CR, 'in sync'); E1 bp-wordpress absent |
