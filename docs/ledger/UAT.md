...
| **bp-gitea/bp-harbor roll (#3296)** | gitea+harbor | 🔴 wedged → fix merged | The #3286 chart roll tripped 2 pre-enforcement kyverno landmines (hook Job not flux-labeled; unproxied `gitea/gitea` + `goharbor/*` images) → both HRs Failed, gitea 503. Source fix #3297 MERGED (bp-gitea 1.2.28 / bp-harbor 1.2.29) — recovery via pin-bump pipeline, being watched. |
