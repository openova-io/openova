...
| **Environment** | [https://marketplace.hw89.omani.works](https://marketplace.hw89.omani.works) → [https://console.hw89.omani.works](https://console.hw89.omani.works) |
...
|---|---|---|---|---|---|
| 1 | [marketplace.hw89.omani.works/redeem/?code=OMANI-WELCOME-7H3K9P2QXR](https://marketplace.hw89.omani.works/redeem/?code=OMANI-WELCOME-7H3K9P2QXR) | Open the redeem link from the email | A voucher preview card: plan name + **OMR credit**, and a **Redeem** button | ✅ | [📷 tc01-1-redeem-preview](evidence/tc01-1-redeem-preview.png) |
...
| 4 | PIN input | Type the 6-digit code from the email | On the 6th digit it auto-submits and lands on **[/dashboard](https://console.hw89.omani.works/dashboard)** — no "could not provision user record" error | ✅ | [📷 tc01-4-dashboard](evidence/tc01-4-dashboard.png) |
...
| # | Screen you're on | What you do | What you must see | Result | Evidence |
|---|---|---|---|---|---|
| 1 | [/dashboard](https://console.hw89.omani.works/dashboard) | Tap **Apps** in the bottom nav | A grid of installed app cards; **Grafana** is one of them | ✅ | [📷 tc02-1-apps-grid](evidence/tc02-1-apps-grid.png) |
| 2 | [/apps](https://console.hw89.omani.works/apps) | Tap the **Grafana** card | The app detail screen **[/app/grafana](https://console.hw89.omani.works/app/grafana)** with a **Launch →** button | ✅ | [📷 tc02-2-app-detail](evidence/tc02-2-app-detail.png) |
| 3 | [/app/grafana](https://console.hw89.omani.works/app/grafana) | Tap **Launch →** | A new tab opens Grafana **already signed in** — no Keycloak username/password form appears | ❌ | [📷 tc02-3-kc-login-shown](evidence/tc02-3-kc-login-shown.png) |
...
| # | Screen you're on | What you do | What you must see | Result | Evidence |
|---|---|---|---|---|---|
| 1 | [/dashboard](https://console.hw89.omani.works/dashboard) | Tap **Sandbox** in the nav | A grid of assistant cards (claude-code, qwen-code, …) | ✅ | [📷 tc03-1-sandbox-grid](evidence/tc03-1-sandbox-grid.png) |
| 2 | [/sandbox](https://console.hw89.omani.works/sandbox) | Tap **claude-code** | A session opens at **[/sandbox/&lt;id&gt;](https://console.hw89.omani.works/sandbox/&lt;id&gt;)** with an interactive terminal pane | ⛔ | — |
| 3 | [/sandbox/<id>](https://console.hw89.omani.works/sandbox/<id>) | Ask *"list my organization's applications"* | The assistant returns your org's apps (not a permission error) | ⛔ | — |
