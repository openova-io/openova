...
> **⚠️ SUPERSEDED (2026-06-16) — this doc targeted hw146.** The current founder acceptance instrument is
> **[`hw147-2026-06-16.md`](hw147-2026-06-16.md)**, which folds in the post-hw146-walk train
> (#3628 OpenBao `/sso/landing`, #3630 cutover chart-mirror + helm-pull gate, #3631 region-b
> data-wiring) and corrects the SovereigntyCard line citations after its Tailwind refactor. Walk
> hw147 from that doc. Kept here for diff/history only.
