...
| Open issues | 6 — EPIC umbrellas (#1099 Cloud Resources [17/20 shipped per Wave 5.62e sweep — Wave 5.63 #2327 YAML→Flux-PR + Wave 5.64 #2328 row-actions filed for the 2 remaining items; item 42 blocks on #1098], #1096 Compliance [contract-verified Wave 5.62d], #1094 Phase 0/1) + #2295 Wave 5.55 walk-verification (awaits fresh prov) + #2327 + #2328. #2303 CLOSED as parked-deferred-to-chepherd-v0.5. |
| Open DoD gates | 7 / 41 |
