...
|  |  |
|---|---|
| Last refreshed | `2026-07-29T12:30:06Z` |
...
**All 63 open issues** grouped by where they sit in the convergence sequence. Each chain runs left-to-right; chains stack vertically.
...
### All 63 open items (clickable table)
