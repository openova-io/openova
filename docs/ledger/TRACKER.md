...
| Open issues | 6 — EPIC umbrellas (#1099 [19/20 shipped], #1096 [11/13 + Waves 5.65/5.66 filed], #1094 Phase 0/1) + #2295 (Wave 5.67 #2334 fixes latent Step 2a KEY_COUNT wc-l bug — TRIGGER/CONTAINMENT/DEFENSE all complete; awaits fresh-prov walk) + #2331 + #2332. #2303/#2327/#2328 CLOSED. |
| Open DoD gates | 7 / 41 |
