...
|  |  |
|---|---|
| Last refreshed | `2026-07-29T13:45:02Z` |
...
**All 65 open issues** grouped by where they sit in the convergence sequence. Each chain runs left-to-right; chains stack vertically.
...
### All 65 open items (clickable table)
