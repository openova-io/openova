...
|  |  |
|---|---|
| Last refreshed | `2026-05-24T02:17:00Z` (🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢 **EPIC #1094 OTel-auto-instr gap FULLY CLOSED on hw01 — 8-PR Wave 5.36→5.41d chain end-to-end VERIFIED**. Operator pod 2/2 Running, 3 OTel CRDs registered (Instrumentation / OpAmpBridge / OpenTelemetryCollector), default Instrumentation CR live with cross-NS exporter endpoint `http://opentelemetry-opentelemetry-collector.opentelemetry.svc:4317`. 4 UAT issues CLOSED via 5-step cycle (#2215 + #2216 + #2219 + #2221) with reviewer concurrence + Playwright screenshot evidence in `docs/sessions/2026-05-24-otel-uat-walk/`. Chain: 5.36 bundle wrong → 5.37 Kyverno wildcard → 5.38/5.39 schema iterations → 5.40 hook (insufficient) → 5.41 chart-split → 5.41b kustomization-add → 5.41c namespace-dedup → 5.41d CRD-prestage final breakthrough. PRs #2210/2217/2220/2222/2226/2229/2230/2231/2232 all MERGED.) |
