...
|  |  |
|---|---|
| Last refreshed | `2026-08-16T06:45:02Z` |
...
| [#6362](https://github.com/openova-io/openova/issues/6362) | MCP accepts no identity on a converged Sovereign — owner's own OIDC token reje | Other |
