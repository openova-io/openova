...
|  |  |
|---|---|
| Last refreshed | `2026-05-24T09:42:00Z` (🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢 **75 PRs merged + 30 Wave issues CLOSED + Wave 5.36→5.62d chain LIVE**: **Wave 5.57e #2324** — sandbox-controller newapi HTTP timeout 30s→60s (cold-start sidecar pull > 30s on HCS). **Wave 5.57d #2323** chart 1.4.47→1.4.48 — sandboxBridge image :be382d4→:latest + pullPolicy IfNotPresent→Always (force fresh-pull every reconcile; kubelet was holding stale image cache that no SHA-bump cleared). **Wave 5.62c #2322** chart 1.4.46→1.4.47 — sandboxBridge knobs in blueprint configSchema (Inviolable Principle #4). **Wave 5.62d** — contract audit on #1096 Compliance backend↔UI: all 5 routes (/scorecard /policies /violations /stream + by-name) match useComplianceStream + compliance.api.ts; no drift. **Wave 5.62a #2319** Compliance sidebar nav (UAT). **Wave 5.57c #2314** checksum/sandbox-bridge annotation. **Wave 5.61 #2313** catalyst-api HPA-down. **Wave 5.60 #2312** bp-openbao fresh-prov CI smoke. **Wave 5.59 #2308** catalyst-api mem 192Mi→96Mi (#2306 CLOSED). **Wave 5.57b #2309** bp-sandbox :3000→:8080. **Wave 5.55 #2310** bp-openbao init 600s→1200s. **Wave 5.57 #2304** sandbox-bridge sidecar. **Wave 5.57a #2301** NetPol catalyst-system. **#2303 walk-verification** w557d-latest-pull sustained PENDING post-5.57d-5.57e (no FAILED bounce after merges); awaits Flux convergence of chart 1.4.48 + sandbox-controller redeploy. Chepherd lift proposal answered. EPIC #1094 ACHIEVED. 3 EPIC umbrellas (#1094 #1096 #1099) remain open. Supervisor coaches resolved: P21 (×17), P22 (×40), P26 (×4), P23/D16 (×1), §1 (×1), D14 (×6).) |
| Open issues | 7 in-progress — #1094 #1096 #1099 + #2371 Wave 5.70 brand-kit + #2390 Wave 5.73 cosign-handoff + #2399 Wave 5.74 Huawei secondary-kubeconfig UAT + #2401 Wave 5.75 hw01 recovery-script UAT + #2404 Wave 5.77 oklch-sweep UAT + #2407 Wave 5.78 compliance-no-data regression + #2408 Wave 5.79 ResourceDetail compliance tab. **Founder UX audit 2026-05-24T12:53+13:00Z**: identified (a) /login + auth pages out-of-sync look-and-feel (Wave 5.76 #2403 + Wave 5.77 #2406 oklch→tokens sweep across 24 files, 117 sites), (b) hw01 /cloud shows 1/1 instead of 2/6 due to secondary-kubeconfig PUT-back gap in Huawei cloud-init (Wave 5.74 #2400 ships fix + Wave 5.75 #2402 recovery script — founder will re-prov), (c) /sre/compliance domain panels empty 'No data yet' despite installed policies (Wave 5.78 #2407), (d) compliance tabs need to live under ResourceDetail (Wave 5.79 #2408). Wave 5.69 ladder COMPLETE end-to-end (CRD #2374 + handler #2395 + UI #2397 + reviewer-fix #2398). Chepherd 4 asks all DONE. **Total this session: 90+ PRs merged + 11 issues closed**. |
| Open DoD gates | 7 / 41 |
