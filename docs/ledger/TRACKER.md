...
| Open issues | 4 — EPIC umbrellas (#1099 Cloud Resources [19/20 shipped per Wave 5.62e final-tally — items 26 YAML→Flux-PR + 29 scale/restart/delete BOTH audit-found already-shipped; only item 42 Realm CLI blocks on #1098], #1096 Compliance [contract-verified Wave 5.62d], #1094 Phase 0/1) + #2295 Wave 5.55 walk-verification. #2303/#2327/#2328 ALL CLOSED. |
| Open DoD gates | 7 / 41 |
