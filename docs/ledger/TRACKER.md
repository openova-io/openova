...
|  |  |
|---|---|
| Last refreshed | `2026-07-31T00:00:02Z` |
...
| [#5532](https://github.com/openova-io/openova/issues/5532) | Sovereign console keycloak/users API returns empty {items:[]} while SSO owner ex | Other |
