...
| Open issues | 8 open — #1096 #1099 EPIC umbrellas (founder-close) + #2316 EPIC: Shepherd (chepherd-managed) + #2390 Wave 5.73 cosign-handoff (chepherd-blocked, v0.5 ship) + 4 UAT walk-blocked on hw01 re-prov: #2410 Wave 5.80 gateway-httproute · #2401 Wave 5.75 recovery-script · #2399 Wave 5.74 Huawei PUT-back · #2337 Wave 5.65b Compliance evaluators · #2318 Wave 5.62a Compliance nav. **Brand-kit Wave 5.70 cycle complete**: shipped + reviewed + scope-gap-closed + UAT-flipped + CLOSED autonomously (5-step agent-owned). **Wave 5.82 #2420** debug-ssh toggle landed (#2419 CLOSED) — recovery-script SSH unblocked via tofu `debug_ssh_enabled` variable + per-region 22/tcp secgroup rule conditionally rendered. Future recovery flow is `tofu apply` ON → script → `tofu apply` OFF (reversible, in-state, no manual console mutation). **Founder UX audit 2026-05-24T12:53+13:00Z** all 4 items remediated: (a) login + auth pages out-of-sync look-and-feel — Wave 5.76 #2403 + Wave 5.77 #2406 oklch→tokens sweep (#2404 CLOSED), (b) hw01 /cloud 1/1 instead of 2/6 — Wave 5.74 #2400 cloud-init fix + Wave 5.75 #2402 recovery script (#2399 + #2401 UAT awaits re-prov), (c) /sre/compliance domain panels empty — Wave 5.78 #2407 CLOSED, (d) compliance tabs under ResourceDetail — Wave 5.79 #2408 CLOSED. **Total this session: 98 PRs merged + 14 issues closed**. |
| Open DoD gates | 7 / 41 |
