...
|  |  |
|---|---|
| Last refreshed | `2026-05-24T06:12:00Z` (🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢 **44 PRs merged + 18 Wave issues CLOSED + Wave 5.36→5.49 chain COMPLETE + Wave 5.44/5.45/5.47/5.48 LIVE-VERIFIED on hw01**: catalyst-api rolled to image f48b57d → \`catalyst_compliance_nats_publish_failures_total\` metric live (counter at 17449 stable post-nack-roll), 6 JetStream CRDs registered, Wave 5.48 auto-bump confirmed working (chart 1.4.261→1.4.262). Pillars 1+4 driven END-TO-END via UI on hw01 (Pillar 1: voucher→marketplace→plan→stack→review→checkout reached; Pillar 4: Sandbox CR pillar4-walk-evidence provisioned by controller). Wave 5.49 #2276 right-sized catalyst-api request + scaled down OTel collector/Flux image-controllers to free hw01 CPU. Walk-evidence in `docs/sessions/2026-05-24-*-walk/`. 3 EPIC umbrellas (#1094 #1096 #1099) remain open per long-running convention. Supervisor coaches resolved: P21 (×10), P22 (×16), P26 (×4), P23/D16 (×1), D14 (×3).) |
