...
|  |  |
|---|---|
| Last refreshed | `2026-05-24T00:25:00Z` (🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢🟢 **Wave 5.36 OTel Operator + default Instrumentation CR shipped (d8240895) — closes EPIC #1094 'no Instrumentation CRs' gap. bp-opentelemetry 1.0.0 → 1.1.0 lockstep (Chart.yaml + blueprint.yaml + 2 bootstrap-kit pins).** Plus prior turn: 37 UAT closures on hw01.omani.works fresh prov 102ac1f980d6fc7f (Huawei HCS). Pillars 1-5 walks (P1 vouchers, P2 BCP wizard, P3 CNPG pair CR, P4 Sandbox 11-manifest GitOps, P5 cutover 9-step chart). 22 UAT closed with Playwright/kubectl/API evidence: #2204/2201/2199/2197/2195/2193/2191/2188/2186/2184/2181/2178/2176/2174/2171/2168/2166/2164/2085/2131/2128/1808.) |
