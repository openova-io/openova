...
| 5.39 | [#2222](https://github.com/openova-io/openova/pull/2222) (MERGED 2026-05-24T01:21Z; **bp-opentelemetry:1.1.2 PUBLISHED**) | <img alt="DONE" src="https://img.shields.io/badge/-DONE-2ea043?style=flat-square" /> | bp-opentelemetry 1.1.1 → 1.1.2 — correct final shape: `replicaCount: 1` at root of `opentelemetry-operator:` subchart + `resources:` under `manager.resources`. Blueprint Release CI passed; chart published to GHCR at sha256-7464b1bf. hw01 picks up on next 15-min Flux reconcile. Per-Wave issue #2221. EPIC #1094 OTel-auto-instr gap CLOSED end-to-end. |
