...
|  |  |
|---|---|
| Last refreshed | `2026-07-05T03:00:02Z` |
...
**All 48 open issues** grouped by where they sit in the convergence sequence. Each chain runs left-to-right; chains stack vertically.
...
### All 48 open items (clickable table)
