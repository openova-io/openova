...
|  |  |
|---|---|
| Last refreshed | `2026-07-29T13:30:05Z` |
...
**All 64 open issues** grouped by where they sit in the convergence sequence. Each chain runs left-to-right; chains stack vertically.
...
### All 64 open items (clickable table)
