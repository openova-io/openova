...
| Open issues | 6 — EPIC umbrellas (#1099 Cloud Resources [19/20 shipped — Wave 5.62e + audit; item 42 Realm CLI blocks on #1098], #1096 Compliance [11/13 shipped per Wave 5.62f — Wave 5.65 #2331 custom-evaluators + Wave 5.66 #2332 Mimir trend filed for remaining 2], #1094 Phase 0/1) + #2295 Wave 5.55 walk-verification + #2331 + #2332. #2303/#2327/#2328 CLOSED. |
| Open DoD gates | 7 / 41 |
