...
| Open issues | 4 — EPIC umbrellas (#1099 Cloud Resources [15/20 shipped per Wave 5.62e sweep], #1096 Compliance [contract-verified Wave 5.62d], #1094 Phase 0/1) + #2295 Wave 5.55 walk-verification (awaits fresh prov). #2303 CLOSED as parked-deferred-to-chepherd-v0.5 after 5 chart waves shipped end-to-end without unblocking hw01 walk (root cause is sidecar-runtime not chart-propagation — needs hw01 kubectl access). |
| Open DoD gates | 7 / 41 |
