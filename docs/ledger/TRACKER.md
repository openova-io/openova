...
|  |  |
|---|---|
| Last refreshed | `2026-07-15T03:30:04Z` |
...
**All 41 open issues** grouped by where they sit in the convergence sequence. Each chain runs left-to-right; chains stack vertically.
...
### All 41 open items (clickable table)
