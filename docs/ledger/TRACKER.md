...
**hw53 wiped 12:30Z (missing G2). hw54 (b49ee16f7982df39) POSTed 12:22Z** carrying full G2+G3+G21+G22+G24+G25 stack from mothership image `a115827`. Verifier expected ~13:02Z. #2570 closure pending if verifier returns green.
