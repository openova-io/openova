# UAT status log + narrative (archived from UAT.md, 2026-06-05)

> The live UAT matrix is now the single flat table in [`../../ledger/UAT.md`](../../ledger/UAT.md).
> This file holds the progress log, per-prov status detail, journey verdicts, coverage contract, summary + appendices that used to clutter the main doc.
...
## 📸 hw99 fresh-prov walk — LIVE evidence (2026-06-05)

Operator signed in to the live hw99 console via **email-PIN (TC-02 ✅)** — `emrah.baysal@openova.io` → 6-digit PIN from the mailbox → authenticated. **hw99 CONVERGED + SERVING** — 2-region, dep `02a4b48a31142cc9`, `hw99.omantel.biz`. Each row: **left** = the live page tested (click to open) · **middle** = test case · **right** = the screenshot on GitHub (click to view).

### Post-handover Sovereign console (operator's real DoD surface)

| Tested page (click to open) | Test case / explanation | Screenshot (click to view) |
|---|---|---|
| [console.hw99…/dashboard](https://console.hw99.omantel.biz/dashboard) | **TC-01** — handover lands on Sovereign `/dashboard`; no login, no FQDN typed | [view image](../sessions/2026-06-05/evidence/hw99-tc01-handover-dashboard.png) |
| [console.hw99…/settings](https://console.hw99.omantel.biz/settings) | **TC-03** — Settings renders real Sovereign values | [view image](../sessions/2026-06-05/evidence/hw99-tc03-settings-real.png) |
| [console.hw99…/users](https://console.hw99.omantel.biz/users) | **TC-03** — operator listed at owner tier | [view image](../sessions/2026-06-05/evidence/hw99-tc03-users-owner.png) |
...
### Pre-handover provisioning console (operator watching the build — apps PENDING)

| Tested page (click to open) | Test case / explanation | Screenshot (click to view) |
|---|---|---|
| [provision/…/](https://console.openova.io/sovereign/provision/02a4b48a31142cc9) | **TC-01** — provisioning progress, 49 apps PENDING | [view image](../sessions/2026-06-05/evidence/hw99-tc01-provisioning-apps-pending.png) |
| [provision/…/dashboard](https://console.openova.io/sovereign/provision/02a4b48a31142cc9/dashboard) | Dashboard during provisioning | [view image](../sessions/2026-06-05/evidence/hw99-dashboard-provisioning.png) |
| [provision/…/users](https://console.openova.io/sovereign/provision/02a4b48a31142cc9/users) | Users during provisioning | [view image](../sessions/2026-06-05/evidence/hw99-users.png) |
| [provision/…/settings](https://console.openova.io/sovereign/provision/02a4b48a31142cc9/settings) | Settings during provisioning | [view image](../sessions/2026-06-05/evidence/hw99-settings.png) |
| [provision/…/cloud](https://console.openova.io/sovereign/provision/02a4b48a31142cc9/cloud) | Cloud during provisioning | [view image](../sessions/2026-06-05/evidence/hw99-cloud.png) |
| [provision/…/jobs](https://console.openova.io/sovereign/provision/02a4b48a31142cc9/jobs) | Jobs during provisioning | [view image](../sessions/2026-06-05/evidence/hw99-jobs.png) |
