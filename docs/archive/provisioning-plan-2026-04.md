...
> **ARCHIVED.** This is the original date-stamped Catalyst-Zero consolidation + cutover plan from 2026-04-29. Moved to `archive/` as part of the docs consolidation that folded 12 orphan top-level docs into 8 canonical top-level docs. Current implementation status of the items below lives in [`../STATUS.md`](../STATUS.md); current operator runbook for bringing up a Sovereign lives in [`../RUNBOOKS.md`](../RUNBOOKS.md) §8.
>
