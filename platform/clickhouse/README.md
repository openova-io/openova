...
Column-oriented OLAP database for real-time analytics. **Application Blueprint** (see [`docs/ARCHITECTURE.md`](../../docs/ARCHITECTURE.md) §4.1) — installed by Organizations that want OLAP. Planned consumer: `bp-fabric` (products/fabric — currently a scaffold, not yet shipping); also the intended cold-storage tier of the SIEM pipeline (`docs/SRE.md` §10).
