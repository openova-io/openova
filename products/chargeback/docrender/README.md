...
```jsonc
{
  ...
  "document": {
    ...
    "tax":       { "exempt": false, "exempt_reason": "…", "discount_rule": "best-single",
                   "summary": [ { "label": "Oman VAT standard", "kind": "standard",
                                  "rate": "0.05", "base": "360.000000", "amount": "18.000000" },
                                { "label": "Zero-rated storage", "kind": "zero_rated",
                                  "rate": "0", "base": "108.000000", "amount": "0.000000",
                                  "note": "Zero-rated supply." } ],
                   "notes": [ "Zero-rated supply." ],
                   "qr_payload": "<base64 TLV>" },
