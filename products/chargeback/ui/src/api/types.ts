...
/** The eight roles of the access model (DESIGN.md §10.3, §11.5). */
export type BindingRole =
  ...
  | 'customer-billing'
  | 'customer-viewer'
/** A partner binding expands to its customers plus its own party (DESIGN.md §11.5). */
export type ScopeKind = 'sovereign' | 'partner' | 'customer'
/** The eleven permissions (DESIGN.md §10.2, §11.5). */
...
// ---------------------------------------------------------------------------
// Partners — resellers and agents (DESIGN.md §11)
// ---------------------------------------------------------------------------
