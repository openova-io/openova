...
import { discountPhase, discountScopeText, discountValueText, discountWindowText, isGlobalDiscount, sortDiscounts, discountPreview, discountState, validateDiscount } from './discounts'
