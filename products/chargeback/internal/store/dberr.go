...
var constraintMessages = map[string]string{
	...
	"capacity_placements_pkey":                       "that SKU is already placed on this pool at that class",
	"capacity_resource_classes_pkey":                 "that resource already has a class set",
	"capacity_pools_classes_check":                   "a pool enforces at least one of guaranteed, burstable and spot, and nothing else",
	"capacity_pool_resources_guaranteed_floor_check": "a guaranteed floor cannot be negative",
	"capacity_resource_classes_class_check":          "a class is one of guaranteed, burstable and spot",
	"capacity_resource_classes_resource_id_check":    "a resource needs an id",
	"capacity_resource_classes_source_id_fkey":       "that cost source does not exist",
