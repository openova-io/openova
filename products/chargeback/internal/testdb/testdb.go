...
const wipeSQL = `TRUNCATE TABLE audit_log, sessions, pins, invites, rated_lines, statements, usage_records, resource_inventory, cost_sources, credentials, customer_users, discounts, budgets, budget_alerts, saved_views, report_deliveries, report_schedules, customers, price_items, price_books RESTART IDENTITY CASCADE;
