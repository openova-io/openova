...
## 11. Partners — resellers and agents (founder direction 2026-09-11)
...
### 11.1 The waterfall — one list price, two independent steps
...
Its customers are rated at the partner's **derived retail book** (§11.3) for
...
### 11.3 A partner is a PARTY — it reuses the customer ledger
