...
export const PLATFORM_COMPONENTS: PlatformComponent[] = [
  ...
  // Optional — Storage
  { id: 'minio', name: 'MinIO', description: 'High-performance S3-compatible object storage', category: 'storage', required: false, dependencies: [], version: 'RELEASE.2025-01-20' },
  { id: 'velero', name: 'Velero', description: 'Backup & restore Kubernetes workloads', category: 'backup', required: false, dependencies: ['minio'], version: 'v1.14.0' },
  ...
  // Optional — Registry
  { id: 'harbor', name: 'Harbor', description: 'Container registry with scanning & signing', category: 'registry', required: false, dependencies: ['cnpg', 'minio', 'valkey'], version: 'v2.11.0' },
